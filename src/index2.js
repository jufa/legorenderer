...
let camera, scene, renderer, plane, tick, raycaster, mouse, meshes, currentIntersect, highlightMaterial, storedMaterial;
let E755, EXX;
...
function init() {
  ...
  directionalLight.position.set( - 2000, 200, 1000 );
  ...
  const directionalLight3 = new THREE.PointLight( 0xffffff, 0.4 );
...
function updateGrid() {
  plane.position.z += 40.0;
  if (plane.position.z > 800.0){
    plane.position.z = 0;
  }
}
